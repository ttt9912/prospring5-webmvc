...
@Slf4j
@Configuration
@EnableJpaRepositories(basePackages = {"ch.basebeans.repository"})
@ComponentScan(basePackages = {"ch.basebeans.service"})
public class DataConfig {
    ...
    public EntityManagerFactory entityManagerFactory() {
        ...
        factoryBean.setPackagesToScan("ch.basebeans.entity");
